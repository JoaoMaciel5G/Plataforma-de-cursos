export default function TextList(){
    return(
        <div>
            ...
            <p className="text-lg">Por isso se você quer ser um programador de sucesso, e se <span>destacar</span> você precisa de um bom método de ensino, e um conteúdo de fácil entendimento, venha com a gente que eu te garanto tudo isso e muito mais, o que eu gastei anos e horas para aprender, você vai aprender em poucos meses.</p>
        </div>
    )
}